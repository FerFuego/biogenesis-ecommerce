...
/**
 * 
 * Template Name: Reportes CSV (Vendedores)
 *
...
$tecnicoVendedorId = sanitize_text_field( get_query_var( 'tecnicovendedorid' ) ); ///
...
if ($tecnicoVendedorId) {
    ...
    $header = array('Nro. De Orden', 'Veterinaria', 'Mail Veterinaria', 'Mail Veterinaria Alternativo', 'Provincia', 'Localidad', 'Tecnico/Vendedor', 'Codigo de Descuento', 'Producto', 'Presentacion', 'Cantidad', 'Descuento Alcanzado', 'Monto Total', 'Productor', 'Razon Social', 'CUIT', 'Email', 'Telefono', 'Fecha Orden', 'Estado Orden');
