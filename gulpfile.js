/**
 * TODO: rework javascript with proper requires/includes (see common.js or require.js)
 * Configure eslintrc to work with said requires
 * re-enable eslint task and turn on option to FAIL on errors
 */
...
// Compile Admin JS
gulp.task('admin_js', /*[ 'lint' ],*/ function () {
...
// Default
gulp.task( 'default', [ 'sass', 'vendor_js', 'app_js', 'admin_js' ] );
...
gulp.task( 'watch', function() {
	gulp.watch( path.WATCH_ADMIN_JS, ['admin_js']);
