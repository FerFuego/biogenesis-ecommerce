...
<div class="reset-password" style="background-image:url('<?php echo wp_is_mobile() && $loginBackgroundMobile ? the_field('login__background-mobile', 'options') : the_field('login__background', 'options'); ?>');">
	...
	<div class="reset-password__container">
		...
		<form method="post" class="woocommerce-ResetPassword lost_reset_password">
			...
			<p class="reset-password__copy"><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Reestablecer Contraseña.', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
			...
			<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
				<label for="password_2"><?php esc_html_e( 'Repetir Contraseña', 'woocommerce' ); ?></label>
			...
			<p class="reset-password__btn-container woocommerce-form-row form-row">
				<input type="hidden" name="wc_reset_password" value="true" />
				<button type="submit" class="reset-password__btn woocommerce-Button button" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
			</p>
